 ...
 * 
 */
const sysObsKey = Symbol('system-observer-key');
/**
 * 
 */
 ...
 * 
 */
const validOptionsKeys = ['path', 'pathsFrom'];
/**
 * 
 */
...
const prepareArray = function (source, observer) {
    let l = source.length,
        item;
...
const prepareObject = function (source, observer) {
...
// jshint -W083
const callObservers = function (observers, changes) {
...
const getAncestorInfo = function (self) {
    const tmp = [];
    let l1 = 0,
        l2 = 0;
    while (self.parent) {
